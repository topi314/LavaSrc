...
@Component
public class LavaSrcJsonAppender implements AudioTrackJsonAppender, AudioPlaylistJsonAppender {

	@Override
	public Map<String, JsonNode> appendFields(AudioPlaylist playlist) {
	...
	@Override
	public Map<String, JsonNode> appendFields(AudioTrack audioTrack) {
		var map = new HashMap<String, JsonNode>();
