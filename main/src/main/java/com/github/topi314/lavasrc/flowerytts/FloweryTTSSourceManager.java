...
public class FloweryTTSSourceManager
  ...
  public Map<String, String> getDefaultConfig() {
    return Map.of(
      ...
      this.voice,
      "translate",
      Boolean.toString(this.translate),
      "silence",
      Integer.toString(this.silence),
      "speed",
    ...
    try {
      ...
      if (text.length() > CHAR_MAX) {
        throw new IllegalArgumentException(
          "Character limit per request exceeded"
        );
      }
