...
public class PersistentHttpStream extends SeekableInputStream implements AutoCloseable{
	...
	private static final Logger log = LoggerFactory.getLogger(com.sedmelluq.discord.lavaplayer.tools.io.PersistentHttpStream.class);
	...
	public InputStream createContentInputStream(HttpResponse response) throws IOException{
		return new BufferedInputStream(currentResponse.getEntity().getContent());
	}
