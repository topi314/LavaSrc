...
public class DeezerAudioTrack extends ExtendedAudioTrack {
	...
	public DeezerAudioTrack(AudioTrackInfo trackInfo, String albumName, String artistArtworkUrl, String previewUrl, String artistUrl, boolean isPreview, DeezerAudioSourceManager sourceManager) {
		super(trackInfo, albumName, artistArtworkUrl, previewUrl, artistUrl, isPreview);
	...
	protected AudioTrack makeShallowClone() {
		return new DeezerAudioTrack(this.trackInfo, this.albumName, this.artistArtworkUrl, this.previewUrl, this.artistUrl, this.isPreview, this.sourceManager);
	}
